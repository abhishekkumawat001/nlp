...
dataloader_wmt = pruner.get_dataloader("wmt16", "de-en", split="validation[:1%]", batch_size=2) # this dataloader will be used for calculating the masks
dataloader_wmt_test = pruner.get_dataloader("wmt16", "de-en", split="test[:1%]", batch_size=2)
